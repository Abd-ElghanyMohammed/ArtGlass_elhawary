...
// Glass Panels Animation Function
function showGlassPanels() {
  const glassPanels = document.getElementById('glassPanels');
  const panels = document.querySelectorAll('.glass-panel');

  // Show the glass panels overlay
  glassPanels.classList.remove('hidden');

  // Animate each panel with delay
...
// Close glass panels function
function closeGlassPanels() {
  const glassPanels = document.getElementById('glassPanels');
  const panels = document.querySelectorAll('.glass-panel');

  // Remove show class from panels
  ...
  setTimeout(() => {
    glassPanels.classList.add('hidden');
  }, 600); // Match the transition duration
}

// Close glass panels when clicking outside
document.getElementById('glassPanels').addEventListener('click', (e) => {
  if (e.target.id === 'glassPanels') {
    closeGlassPanels();
  }
});
